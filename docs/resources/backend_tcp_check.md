---
page_title: "haproxy-dataplane_backend_tcp_check Resource - HAProxy Data Plane"
subcategory: "Configuration"
description: |-
  Manages HAProxy backend tcp check configuration.
---

# haproxy-dataplane_backend_tcp_check (Resource)

Use this resource to manage the backend_tcp_check object in HAProxy Data Plane API.
...
```terraform
resource "haproxy-dataplane_backend_tcp_check" "example" {
