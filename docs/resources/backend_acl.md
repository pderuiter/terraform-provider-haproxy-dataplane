---
page_title: "haproxy-dataplane_backend_acl Resource - HAProxy Data Plane"
subcategory: "Configuration"
description: |-
  Manages HAProxy backend acl configuration.
---

# haproxy-dataplane_backend_acl (Resource)

Use this resource to manage the backend_acl object in HAProxy Data Plane API.
...
```terraform
resource "haproxy-dataplane_backend_acl" "example" {
