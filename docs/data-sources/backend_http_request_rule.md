---
page_title: "haproxy-dataplane_backend_http_request_rule Data Source - HAProxy Data Plane"
subcategory: "Configuration"
description: |-
  Reads HAProxy backend http request rule configuration.
---

# haproxy-dataplane_backend_http_request_rule (Data Source)

Use this data source to read existing backend_http_request_rule configuration from HAProxy.
...
```terraform
data "haproxy-dataplane_backend_http_request_rule" "example" {
}
```
