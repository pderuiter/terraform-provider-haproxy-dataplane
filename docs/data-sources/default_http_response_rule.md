---
page_title: "haproxy-dataplane_default_http_response_rule Data Source - HAProxy Data Plane"
subcategory: "Configuration"
description: |-
  Reads HAProxy default http response rule configuration.
---

# haproxy-dataplane_default_http_response_rule (Data Source)

Use this data source to read existing default_http_response_rule configuration from HAProxy.
...
```terraform
data "haproxy-dataplane_default_http_response_rule" "example" {
}
```
