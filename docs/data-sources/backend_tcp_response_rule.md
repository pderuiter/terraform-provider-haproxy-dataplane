---
page_title: "haproxy-dataplane_backend_tcp_response_rule Data Source - HAProxy Data Plane"
subcategory: "Configuration"
description: |-
  Reads HAProxy backend tcp response rule configuration.
---

# haproxy-dataplane_backend_tcp_response_rule (Data Source)

Use this data source to read existing backend_tcp_response_rule configuration from HAProxy.
...
```terraform
data "haproxy-dataplane_backend_tcp_response_rule" "example" {
}
```
