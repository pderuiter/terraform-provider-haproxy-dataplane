---
page_title: "haproxy-dataplane_default_tcp_request_rule Data Source - HAProxy Data Plane"
subcategory: "Configuration"
description: |-
  Reads HAProxy default tcp request rule configuration.
---

# haproxy-dataplane_default_tcp_request_rule (Data Source)

Use this data source to read existing default_tcp_request_rule configuration from HAProxy.
...
```terraform
data "haproxy-dataplane_default_tcp_request_rule" "example" {
}
```
