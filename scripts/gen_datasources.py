...
for path, item in config_paths.items():
    ...
    elif resp.get('type') == 'integer':
        # use Dynamic for scalar endpoints (e.g., version)
        schema_name = None
    else:
        continue
    ...
    datasources.append({
        ...
        'is_array': is_array,
        'is_scalar': resp.get('type') == 'integer',
    })
...
with open(OUT_DIR / 'datasources_gen.go', 'w') as f:
    f.write("// Code generated by scripts/gen_datasources.py. DO NOT EDIT.\n")
    f.write("package provider\n\n")
    f.write("import (\n\t\"github.com/hashicorp/terraform-plugin-framework/datasource\"\n)\n\n")
    f.write("func generatedDataSources() []func() datasource.DataSource {\n\treturn []func() datasource.DataSource{\n")
    for d in datasources:
