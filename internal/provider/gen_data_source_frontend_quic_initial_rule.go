...
var _ datasource.DataSource = (*frontend_quic_initial_ruleDataSource)(nil)

func NewFrontendQuicInitialRuleDataSource() datasource.DataSource {
	return &frontend_quic_initial_ruleDataSource{}
}

type frontend_quic_initial_ruleDataSource struct {
...
func (d *frontend_quic_initial_ruleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state frontend_quic_initial_ruleDataSourceModel
