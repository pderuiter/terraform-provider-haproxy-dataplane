...
var _ resource.Resource = (*log_forward_log_targetResource)(nil)

func NewLogForwardLogTargetResource() resource.Resource {
	return &log_forward_log_targetResource{}
}

type log_forward_log_targetResource struct {
...
func (r *log_forward_log_targetResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan log_forward_log_targetModel
...
func (r *log_forward_log_targetResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state log_forward_log_targetModel
...
func (r *log_forward_log_targetResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan log_forward_log_targetModel
	resp.Diagnostics.Append(req.Plan.Get(ctx, &plan)...)
	if resp.Diagnostics.HasError() {
		return
...
func (r *log_forward_log_targetResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state log_forward_log_targetModel
	resp.Diagnostics.Append(req.State.Get(ctx, &state)...)
	if resp.Diagnostics.HasError() {
		return
...
var _ resource.ResourceWithConfigure = (*log_forward_log_targetResource)(nil)
