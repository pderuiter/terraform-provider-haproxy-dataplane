...
var _ datasource.DataSource = (*runtime_ssl_crt_list_entryDataSource)(nil)

func NewRuntimeSslCrtListEntryDataSource() datasource.DataSource {
	return &runtime_ssl_crt_list_entryDataSource{}
}

type runtime_ssl_crt_list_entryDataSource struct {
...
func (d *runtime_ssl_crt_list_entryDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_runtime_ssl_crt_list_entry"
}
...
func (d *runtime_ssl_crt_list_entryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state runtime_ssl_crt_list_entryDataSourceModel
	...
	path := buildPath("/services/haproxy/runtime/ssl_crt_lists/entries", map[string]string{})
