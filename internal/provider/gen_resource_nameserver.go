...
var _ resource.Resource = (*nameserverResource)(nil)
...
func (r *nameserverResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	attrs, ok := schemaAttributesFor("nameserver")
	if !ok {
...
func (r *nameserverResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	query := url.Values{
		...
		"resolver": []string{plan.Resolver.ValueString()},
	}
	...
	plan.ID = types.StringValue(strings.Join([]string{plan.Name.ValueString(), plan.Resolver.ValueString()}, "/"))
	plan.Spec, diags = mapToObject(ctx, mustSchemaAttrTypes("nameserver"), payload, []string{"name"})
	resp.Diagnostics.Append(diags...)
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *nameserverResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state nameserverModel
	...
	path := buildPath("/services/haproxy/configuration/nameservers/{name}", map[string]string{
	...
	state.Spec, diags = mapToObject(ctx, mustSchemaAttrTypes("nameserver"), out, []string{"name"})
	resp.Diagnostics.Append(diags...)
...
var _ resource.ResourceWithConfigure = (*nameserverResource)(nil)
