...
var _ resource.Resource = (*fcgi_appResource)(nil)

func NewFcgiAppResource() resource.Resource {
	return &fcgi_appResource{}
}

type fcgi_appResource struct {
	client *client.Client
}

type fcgi_appModel struct {
	ID   types.String `tfsdk:"id"`
	Name types.String `tfsdk:"name"`
	Spec types.Object `tfsdk:"spec"`
}

func (r *fcgi_appResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_fcgi_app"
}

func (r *fcgi_appResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	attrs, ok := schemaAttributesFor("fcgi_app")
	if !ok {
...
func (r *fcgi_appResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan fcgi_appModel
...
func (r *fcgi_appResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state fcgi_appModel
...
func (r *fcgi_appResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan fcgi_appModel
	resp.Diagnostics.Append(req.Plan.Get(ctx, &plan)...)
	if resp.Diagnostics.HasError() {
		return
...
func (r *fcgi_appResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state fcgi_appModel
	resp.Diagnostics.Append(req.State.Get(ctx, &state)...)
	if resp.Diagnostics.HasError() {
		return
...
var _ resource.ResourceWithConfigure = (*fcgi_appResource)(nil)
