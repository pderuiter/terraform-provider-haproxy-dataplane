...
var _ resource.Resource = (*programResource)(nil)
...
func (r *programResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	attrs, ok := schemaAttributesFor("program")
	if !ok {
...
func (r *programResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	plan.Spec, diags = mapToObject(ctx, mustSchemaAttrTypes("program"), payload, []string{"name"})
	resp.Diagnostics.Append(diags...)
...
func (r *programResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	query := url.Values{}
	path := buildPath("/services/haproxy/configuration/programs/{name}", map[string]string{
	...
	state.Spec, diags = mapToObject(ctx, mustSchemaAttrTypes("program"), out, []string{"name"})
	resp.Diagnostics.Append(diags...)
...
var _ resource.ResourceWithConfigure = (*programResource)(nil)
