...
var _ datasource.DataSource = (*backend_http_after_response_ruleDataSource)(nil)

func NewBackendHttpAfterResponseRuleDataSource() datasource.DataSource {
	return &backend_http_after_response_ruleDataSource{}
}

type backend_http_after_response_ruleDataSource struct {
...
func (d *backend_http_after_response_ruleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state backend_http_after_response_ruleDataSourceModel
