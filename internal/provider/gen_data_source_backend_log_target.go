...
var _ datasource.DataSource = (*backend_log_targetDataSource)(nil)

func NewBackendLogTargetDataSource() datasource.DataSource {
	return &backend_log_targetDataSource{}
}

type backend_log_targetDataSource struct {
...
func (d *backend_log_targetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state backend_log_targetDataSourceModel
