locals {
  default_http_request_rule_name = "managed_default_http_request_rule"
}
...
resource "haproxy-dataplane_default_http_request_rule" "managed" {
...
output "default_http_request_rule_id" {
  value = haproxy-dataplane_default_http_request_rule.managed.id
}
