locals {
  default_tcp_request_rule_name = "managed_default_tcp_request_rule"
}
...
resource "haproxy-dataplane_default_tcp_request_rule" "managed" {
...
output "default_tcp_request_rule_id" {
  value = haproxy-dataplane_default_tcp_request_rule.managed.id
}
