locals {
  default_http_response_rule_name = "managed_default_http_response_rule"
}
...
resource "haproxy-dataplane_default_http_response_rule" "managed" {
...
output "default_http_response_rule_id" {
  value = haproxy-dataplane_default_http_response_rule.managed.id
}
