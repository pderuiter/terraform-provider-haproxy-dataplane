locals {
  default_quic_initial_rule_name = "managed_default_quic_initial_rule"
}
...
resource "haproxy-dataplane_default_quic_initial_rule" "managed" {
...
output "default_quic_initial_rule_id" {
  value = haproxy-dataplane_default_quic_initial_rule.managed.id
}
