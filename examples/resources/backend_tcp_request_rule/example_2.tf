locals {
  backend_tcp_request_rule_name = "managed_backend_tcp_request_rule"
}
...
resource "haproxy-dataplane_backend_tcp_request_rule" "managed" {
...
output "backend_tcp_request_rule_id" {
  value = haproxy-dataplane_backend_tcp_request_rule.managed.id
}
