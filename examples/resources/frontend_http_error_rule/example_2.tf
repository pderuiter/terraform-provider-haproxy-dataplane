locals {
  frontend_http_error_rule_name = "managed_frontend_http_error_rule"
}
...
resource "haproxy-dataplane_frontend_http_error_rule" "managed" {
...
output "frontend_http_error_rule_id" {
  value = haproxy-dataplane_frontend_http_error_rule.managed.id
}
